...
from .resnet_afp import ResNet_afp2, ResNet_afp3, ResNet_afp4
...
class ResNeXt_FT2(ResNet_afp2):
    ...
    def __init__(self, groups=1, base_width=4, **kwargs):
        ...
        super(ResNeXt_FT2, self).__init__(**kwargs)
...
class ResNeXt_FT3(ResNet_afp3):
    ...
    def __init__(self, groups=1, base_width=4, **kwargs):
        self.groups = groups
        self.base_width = base_width
        super(ResNeXt_FT3, self).__init__(**kwargs)
...
class ResNeXt_FT4(ResNet_afp4):
    ...
    def __init__(self, groups=1, base_width=4, **kwargs):
        self.groups = groups
        self.base_width = base_width
        super(ResNeXt_FT4, self).__init__(**kwargs)
